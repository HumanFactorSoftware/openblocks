import { g as $, c as I, d as X, p as Y } from "./4ed63aec.js";
import G from "react";
function J(t, o) {
 ...
 */
function T(t, o, n) {
  this.x = t, this.y = o, this.time = n || new Date().getTime();
}
...
A.prototype._point = function(t, o, n, e, i) {
...
function K(t, o, n) {
  ...
  n || (n = {});
  var l = function() {
    u = n.leading === !1 ? 0 : Date.now(), a = null, s = t.apply(e, i), a || (e = i = null);
  };
  return function() {
    var r = Date.now();
    !u && n.leading === !1 && (u = r);
    var c = o - (r - u);
    return e = this, i = arguments, c <= 0 || c > o ? (a && (clearTimeout(a), a = null), u = r, s = t.apply(e, i), a || (e = i = null)) : !a && n.trailing !== !1 && (a = setTimeout(l, c)), s;
  };
}
function _(t, o) {
  var n = this, e = o || {};
  this.velocityFilterWeight = e.velocityFilterWeight || 0.7, this.minWidth = e.minWidth || 0.5, this.maxWidth = e.maxWidth || 2.5, this.throttle = "throttle" in e ? e.throttle : 16, this.minDistance = "minDistance" in e ? e.minDistance : 5, this.throttle ? this._strokeMoveUpdate = K(_.prototype._strokeUpdate, this.throttle) : this._strokeMoveUpdate = _.prototype._strokeUpdate, this.dotSize = e.dotSize || function() {
    ...
    i.which === 1 && (n._mouseButtonDown = !0, n._strokeBegin(i));
  }, this._handleMouseMove = function(i) {
    n._mouseButtonDown && n._strokeMoveUpdate(i);
  }, this._handleMouseUp = function(i) {
    i.which === 1 && n._mouseButtonDown && (n._mouseButtonDown = !1, n._strokeEnd(i));
...
_.prototype._createPoint = function(t, o, n) {
  ...
  return new T(t - e.left, o - e.top, n || new Date().getTime());
};
_.prototype._addPoint = function(t) {
  ...
  if (o.push(t), o.length > 2) {
    ...
    var i = n.c1, s = new A(o[1], e, i, o[2]), a = this._calculateCurveWidths(s);
...
_.prototype._drawPoint = function(t, o, n) {
  var e = this._ctx;
  e.moveTo(t, o), e.arc(t, o, n, 0, 2 * Math.PI, !1), this._isEmpty = !1;
};
...
_.prototype._toSVG = function() {
  ...
  l.setAttributeNS(null, "width", n.width), l.setAttributeNS(null, "height", n.height), this._fromData(o, function(v, E, M) {
    var C = document.createElement("path");
    if (!isNaN(v.control1.x) && !isNaN(v.control1.y) && !isNaN(v.control2.x) && !isNaN(v.control2.y)) {
      var W = "M " + v.startPoint.x.toFixed(3) + "," + v.startPoint.y.toFixed(3) + " " + ("C " + v.control1.x.toFixed(3) + "," + v.control1.y.toFixed(3) + " ") + (v.control2.x.toFixed(3) + "," + v.control2.y.toFixed(3) + " ") + (v.endPoint.x.toFixed(3) + "," + v.endPoint.y.toFixed(3));
      C.setAttribute("d", W), C.setAttribute("stroke-width", (E.end * 2.25).toFixed(3)), C.setAttribute("stroke", M), C.setAttribute("fill", "none"), C.setAttribute("stroke-linecap", "round"), l.appendChild(C);
    }
  }, function(v) {
    var E = document.createElement("circle"), M = typeof t.dotSize == "function" ? t.dotSize() : t.dotSize;
    E.setAttribute("r", M), E.setAttribute("cx", v.x), E.setAttribute("cy", v.y), E.setAttribute("fill", v.color), l.appendChild(E);
  });
...
const Q = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: _
}, Symbol.toStringTag, { value: "Module" })), Z = /* @__PURE__ */ $(Q);
var R = { exports: {} }, q;
function tt() {
  return q || (q = 1, function(t, o) {
    (function(n, e) {
      t.exports = e();
    })(I, function() {
      return function(n) {
        function e(s) {
          ...
          return n[s].call(a.exports, a, a.exports, e), a.loaded = !0, a.exports;
        }
        var i = {};
        return e.m = n, e.c = i, e.p = "", e(0);
      }([function(n, e) {
        function i(r) {
          var c = r.getContext("2d"), f = r.width, p = r.height, y = c.getImageData(0, 0, f, p).data, x = u(!0, f, p, y), g = u(!1, f, p, y), P = l(!0, f, p, y), v = l(!1, f, p, y), E = v - P + 1, M = g - x + 1, C = c.getImageData(P, x, E, M);
          return r.width = E, r.height = M, c.clearRect(0, 0, E, M), c.putImageData(C, 0, 0), r;
        }
        function s(r, c, f, p) {
...
(function(t, o) {
  (function(n, e) {
    t.exports = e(Y.exports, G, Z, tt());
  })(I, function(n, e, i, s) {
    return function(a) {
      function u(r) {
        if (l[r])
          return l[r].exports;
        var c = l[r] = { exports: {}, id: r, loaded: !1 };
        return a[r].call(c.exports, c, c.exports, u), c.loaded = !0, c.exports;
      }
      var l = {};
      ...
      }(), P = l(1), v = r(P), E = l(2), M = r(E), C = l(3), W = r(C), V = l(4), H = r(V), L = function(m) {
        function d() {
          var b, w, h, B;
          f(this, d);
          for (var j = arguments.length, F = Array(j), S = 0; S < j; S++)
            F[S] = arguments[S];
          return w = h = p(this, (b = d.__proto__ || Object.getPrototypeOf(d)).call.apply(b, [this].concat(F))), h._sigPad = null, h._excludeOurProps = function() {
            var D = h.props, O = (D.canvasProps, D.clearOnResize, c(D, ["canvasProps", "clearOnResize"]));
            return O;
          }, h.getCanvas = function() {
            return h._canvas;
          }, h.getTrimmedCanvas = function() {
            var D = document.createElement("canvas");
            return D.width = h._canvas.width, D.height = h._canvas.height, D.getContext("2d").drawImage(h._canvas, 0, 0), (0, H.default)(D);
          }, h.getSignaturePad = function() {
            return h._sigPad;
          }, h._checkClearOnResize = function() {
            h.props.clearOnResize && h._resizeCanvas();
          }, h._resizeCanvas = function() {
            var D = h.props.canvasProps || {}, O = D.width, N = D.height;
            if (!O || !N) {
              var k = h._canvas, z = Math.max(window.devicePixelRatio || 1, 1);
              O || (k.width = k.offsetWidth * z), N || (k.height = k.offsetHeight * z), k.getContext("2d").scale(z, z), h.clear();
            }
          }, h.on = function() {
          ...
          }, h.fromDataURL = function(D, O) {
            return h._sigPad.fromDataURL(D, O);
          }, h.toDataURL = function(D, O) {
            return h._sigPad.toDataURL(D, O);
          }, h.fromData = function(D) {
            return h._sigPad.fromData(D);
          }, h.toData = function() {
            return h._sigPad.toData();
          }, B = w, p(h, B);
        }
        return y(d, m), g(d, [{ key: "componentDidMount", value: function() {
          this._sigPad = new W.default(this._canvas, this._excludeOurProps()), this._resizeCanvas(), this.on();
...
const et = /* @__PURE__ */ X(U.exports), it = /* @__PURE__ */ J({
  __proto__: null,
  default: et
}, [U.exports]);
export {
