...
export { ReactComponent as FormBuilderIcon } from "./icon-lottie.svg";
export { ReactComponent as MasonryIcon } from "./icon-masonry.svg";
export { ReactComponent as TabsControlIcon } from "./icon-tabs-control.svg";
